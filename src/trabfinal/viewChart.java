...
public class viewChart extends JFrame {
    ...
    public viewChart(String applicationTitle, String chartTitle, ArrayList<Double> topBand, ArrayList<Double> lowerBand, ArrayList<Double> close, ArrayList<Long> dates) {
        super(applicationTitle);
        JFreeChart xylineChart = ChartFactory.createXYLineChart(
                chartTitle,
                "Category",
    ...
    public void updateChart(String applicationTitle, String chartTitle, ArrayList<Double> a, ArrayList<Double> b, ArrayList<Long> c) {
        JFreeChart xylineChart = ChartFactory.createXYLineChart(
                chartTitle,
                "Category",
                "Score",
